...
<div class="field_row clearfix">	
<?php echo form_label($this->lang->line('user_log_log_message').':', 'Log activity',array('class'=>' wide')); ?>
	<div class='form_field'>
        <?php echo form_label($user_log_info->log_message, 'user',array('class'=>' wide info-label')); ?>
