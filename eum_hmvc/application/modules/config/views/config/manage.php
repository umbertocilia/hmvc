                        ...
                        <div class="form-group">
						 ...
						 <div class="form-group"  >
                           ...
                           <div class='col-sm-7'>
                         	 ...
                         	 <div class="form-group"  >
                           <?php echo form_label($this->lang->line('config_throttle_limit').':', 'pagination',array('class'=>'col-sm-5 control-label')); ?>
                           <div class='col-sm-7'>
                              <?php echo form_input(array(
                                 'name'=>'throttle_limit',
                                 'id'=>'throttle_limit',
                                 'class'=>'form-control', 
                                 'value'=>$this->config->item('throttle_limit')));?> <span class="info-small" >(<?php echo $this->lang->line('config_throttle_desc');?>)</span>
                           </div><br>
                        </div>
                         
                         	 <div class="form-group"  >
                           <?php echo form_label($this->lang->line('config_throttle_timeout').':', 'pagination',array('class'=>'col-sm-5 control-label')); ?>
                           <div class='col-sm-7'>
                              <?php echo form_input(array(
                                 'name'=>'throttle_timeout',
                                 'id'=>'throttle_timeout',
                                 'class'=>'form-control', 
                                 'value'=>$this->config->item('throttle_timeout')));?> <span class="info-small" >(<?php echo $this->lang->line('config_throttle_timeout_desc');?>)</span>
                           </div><br>
                        </div>
