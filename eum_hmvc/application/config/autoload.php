...
*/
$autoload['helper'] = array('form','url','text', 'html', 'download','table','user_log');
...
|
*/
$autoload['language'] = array('common', 'config','error', 'login', 'module','main_module', 'reports', 'icon','profiles','dashboard','user_log');
