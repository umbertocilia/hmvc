...
--
-- Host: localhost
-- Generation Time: Nov 03, 2017 at 09:21 AM
...
--
-- Table structure for table `eum_actve_sessions`
--

CREATE TABLE IF NOT EXISTS `eum_actve_sessions` (
  `actve_sessions_id` int(11) NOT NULL AUTO_INCREMENT,
  `actve_user_sessions_id` int(11) DEFAULT NULL,
  `user_id` int(11) NOT NULL,
  `ip_address` varchar(260) DEFAULT NULL,
  `user_agent` varchar(260) DEFAULT NULL,
  `log_time` datetime NOT NULL,
  PRIMARY KEY (`actve_sessions_id`)
...
('module_active_sessions', 'module_active_sessions_desc', 30, 'active_sessions', 1, 0),
...
('module_user_logs', 'module_user_logs_desc', 20, 'user_logs', 1, 0),
...
--
-- Table structure for table `eum_throttles`
--

CREATE TABLE IF NOT EXISTS `eum_throttles` (
  `throttles_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `ip` varchar(64) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `attempt_count` int(11) DEFAULT '0',
  `type` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`throttles_id`)
...
--
-- Table structure for table `eum_user_log`
--

CREATE TABLE IF NOT EXISTS `eum_user_log` (
